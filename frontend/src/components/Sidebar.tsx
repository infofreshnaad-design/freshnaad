...
const Sidebar = ({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) => {
  ...
  const menuItems = [
    ...
    { icon: <Package size={22} />, label: 'Purchase Entry', path: '/purchase-entry', roles: ['ADMIN', 'MANAGER'], permissionKey: 'PURCHASE_ENTRY' },
    { icon: <Package size={22} />, label: 'Stock Procurement', path: '/stock-procurement', roles: ['ADMIN', 'MANAGER'], permissionKey: 'STOCK_PROCUREMENT' },
